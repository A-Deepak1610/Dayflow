      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-[13px] text-[#888888] mt-0.5">
            Connect with your colleagues and find people across your
            organization.
          </p>
        </div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white border border-slate-200 rounded-xl p-4 shadow-sm space-y-3">
            ...
            <div className="flex items-center justify-between text-xs text-slate-500 pt-1 border-t border-slate-100">
              <span>
                Showing <strong>{filteredEmployees.length}</strong> colleagues
                across organization
              </span>
          ...
          {filteredEmployees.length > 0 ? (
                  ...
                  >
                    <div>
                      ...
                      <div className="relative mx-auto w-16 h-16 rounded-full mb-3 flex items-center justify-center text-white font-bold text-lg shadow-sm ring-4 ring-slate-50">
                        <div
                          className={`w-full h-full rounded-full ${emp.avatarBg} flex items-center justify-center`}
                        >
                          {initials}
                        </div>
                      </div>
            ...
            <div className="bg-white border border-slate-200 rounded-2xl p-12 text-center shadow-sm space-y-3">
              ...
              <h3 className="font-bold text-[#1F2A52] text-base">
                No employees found
              </h3>
              <p className="text-xs text-slate-500 max-w-md mx-auto">
                Try searching with a different name, employee ID, department, or
                designation.
              </p>
              <button
                onClick={() => {
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <div className="flex items-center gap-2">
                  <h2 className="text-xl font-bold text-[#1F2A52]">
                    {myProfileData.name}
                  </h2>
                ...
                <p className="text-xs text-slate-600 font-medium">
                  {myProfileData.designation} • {myProfileData.department}
                </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm space-y-4">
              <div className="pb-3 border-b border-slate-100 flex items-center justify-between">
                <div>
                  <h3 className="font-bold text-[#1F2A52] text-[15px]">
                    Personal & Contact Details
                  </h3>
                  <p className="text-xs text-slate-500">
                    Editable employee self-service contact parameters
                  </p>
                </div>
              ...
              {isEditingMyProfile ? (
                ...
                <div className="space-y-3 text-xs text-slate-700">
                  ...
                  <div className="p-3 bg-slate-50 rounded-xl border border-slate-200 space-y-1">
                    ...
                    <span className="font-semibold text-slate-900">
                      {myProfileData.emergencyContact}
                    </span>
                  </div>
                </div>
              )}
            ...
            <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm space-y-4">
              <div className="pb-3 border-b border-slate-100 flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-slate-500">
                    Official HR verified employment attributes
                  </p>
                </div>
              ...
              <div className="space-y-3 text-xs text-slate-700">
                ...
                <div className="p-3 bg-slate-50 rounded-xl border border-slate-200 flex justify-between">
                  ...
                  <span className="font-semibold text-slate-900">
                    {myProfileData.joiningDate}
                  </span>
                </div>

                <div className="p-3 bg-slate-50 rounded-xl border border-slate-200 flex justify-between">
                  <span className="text-slate-500">
                    Assigned Seating / Desk:
                  </span>
                  <span className="font-semibold text-slate-900">
                    {myProfileData.workLocation}
                  </span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm space-y-4">
              <div className="pb-3 border-b border-slate-100 flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-slate-500">
                    Confidential monthly compensation breakdown (Read-Only)
                  </p>
                </div>
              ...
              <div className="space-y-2.5 text-xs text-slate-700">
                ...
                <div className="p-2.5 bg-slate-50 rounded-xl border border-slate-200 flex justify-between">
                  ...
                  <span className="font-mono font-extrabold text-[#1F2A52]">
                    ₹80,000 / month
                  </span>
                </div>
              ...
              <div className="pt-2 border-t border-slate-100 flex justify-between items-center text-xs">
                <span className="text-slate-400">
                  Total Annual CTC: ₹9,60,000 / yr
                </span>
                <Link
                  to="/employee/payslips"
                  className="font-bold text-horilla-primary hover:underline"
                >
                  View Payslips &rarr;
                </Link>
              </div>
            ...
            <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm space-y-4">
              <div className="pb-3 border-b border-slate-100 flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-slate-500">
                    Verified employment and identity credentials
                  </p>
                </div>
              ...
              <div className="space-y-2.5 text-xs">
                {[
                  {
                    name: "Offer_Letter_Dayflow_2024.pdf",
                    size: "1.2 MB",
                    type: "Contract",
                    verified: true,
                  },
                  {
                    name: "National_Identity_Card_Aadhaar.pdf",
                    size: "850 KB",
                    type: "KYC",
                    verified: true,
                  },
                  {
                    name: "Degree_Certificate_BE_CS.pdf",
                    size: "2.4 MB",
                    type: "Education",
                    verified: true,
                  },
                  {
                    name: "Form_16_Tax_Declaration_2025.pdf",
                    size: "640 KB",
                    type: "Tax Document",
                    verified: true,
                  },
                  ...
                  <div
                    key={idx}
                    className="p-2.5 bg-slate-50 rounded-xl border border-slate-200 flex items-center justify-between hover:border-slate-300 transition"
                  >
                    <div className="flex items-center gap-2.5">
                      ...
                      <div>
                        <span className="font-bold text-slate-800 block truncate max-w-[200px] sm:max-w-xs">
                          {doc.name}
                        </span>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-xs animate-fade-in">
          <div className="bg-white rounded-2xl max-w-lg w-full p-6 shadow-2xl border border-slate-200 space-y-5 animate-modal-pop relative text-slate-900 max-h-[90vh] overflow-y-auto">
            ...
            <div className="flex items-center gap-4 p-4 bg-slate-50 rounded-2xl border border-slate-200">
              <div
                className={`w-14 h-14 rounded-full ${selectedColleague.avatarBg} text-white font-bold text-lg flex items-center justify-center shrink-0 ring-4 ring-white shadow-sm`}
              >
              ...
              <div>
                <h3 className="font-sora text-base font-bold text-[#1F2A52]">
                  {selectedColleague.name}
                </h3>
            ...
            <div className="p-3 bg-slate-50 rounded-xl border border-slate-200 flex items-center gap-2 text-[11px] text-slate-500">
              ...
              <span>
                Personal contact details & payroll data are kept private under
                Dayflow RBAC.
              </span>
            </div>
